...
fun sendMessageToClient(client: Client?, message: String?, mailer: Mailer) {
    if (null == client || null == message || null == client.personalInfo || null == client.personalInfo.email)
        return

    return mailer.sendMessage(email = client.personalInfo.email, message = message)
}
